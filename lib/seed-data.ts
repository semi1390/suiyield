...
export const SEED_STAKING: YieldEntry[] = [
  { id: "haedal-hasui", protocol: "Haedal", asset: "haSUI", type: "Liquid Staking", apy: 3.5, tvl: 210000000, risk: "low", depositUrl: "https://www.haedal.xyz/stake", color: "#3A9FF5", initials: "H", change24h: 0.1, category: "staking" },
  { id: "aftermath-afsui", protocol: "Aftermath", asset: "afSUI", type: "Liquid Staking", apy: 3.8, tvl: 140000000, risk: "low", depositUrl: "https://aftermath.finance/staking", color: "#EF4444", initials: "Af", change24h: 0.1, category: "staking" },
  { id: "volo-vsui", protocol: "Volo", asset: "vSUI", type: "Liquid Staking", apy: 3.6, tvl: 50000000, risk: "low", depositUrl: "https://www.volosui.com/stake", color: "#10B981", initials: "V", change24h: -0.1, category: "staking" },
  { id: "sui-native", protocol: "Sui Native", asset: "SUI", type: "Staking", apy: 2.8, tvl: 8200000000, risk: "low", depositUrl: "https://springsui.com/SUI-sSUI", color: "#4B8BFF", initials: "S", change24h: 0.0, category: "staking" },
]
